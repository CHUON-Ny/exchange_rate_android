...
public class ExchangeEuroToRielsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exchange_euro_to_riels);
    ...
    public void calculateEuroToRiels(View view) {
